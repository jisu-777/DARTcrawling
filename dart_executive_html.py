...
# get_viewer_url과 _normalize_viewer_url 함수 제거됨 (document.xml API만 사용하므로 불필요)
...
# parse_registered_executives 함수 제거됨 (viewer.do HTML 파싱은 사용하지 않음, document.xml API만 사용)
